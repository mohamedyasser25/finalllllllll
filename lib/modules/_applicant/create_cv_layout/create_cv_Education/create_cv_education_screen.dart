                    ...
                    child: defaultButton(
                      function: () {
                        if (cubit.formKey.currentState!.validate()) {
                          startDate = DateFormat.yMMMd().parse( cubit.startDateTimeController.text);
                          endDate = DateFormat.yMMMd().parse( cubit.endDateTimeController.text);
                          if (startDate != null && endDate != null && startDate!.isBefore(endDate!)) {
                            ...
                            showToast(
                              text: "End date can not be before or as start date",
                              state: ToastStates.ERROR,
                            );
                          }
                        }
